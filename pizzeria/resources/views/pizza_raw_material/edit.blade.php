...
<body>
    <div class="container mt-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="text-danger">Editar Relación Pizza - Materia Prima</h1>
        </div>
        ...
        <form method="POST" action="{{ route('pizza_raw_material.update', ['pizza_raw_material' => $ingredient->id]) }}">
            ...
            <div class="mb-3">
                ...
                <div class="form-text">ID de la relación</div>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" min="0" class="form-control" id="quantity" name="quantity"
                    value="{{ $ingredient->quantity }}" placeholder="Cantidad utilizada">
            </div>

            <div class="mt-3">
                <button type="submit" class="btn btn-danger">Actualizar</button>
                <a href="{{ route('pizza_raw_material.index') }}" class="btn btn-warning">Cancelar</a>
            </div>
        </form>
    </div>
