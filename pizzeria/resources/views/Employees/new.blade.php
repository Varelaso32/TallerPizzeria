...
<body>
    <div class="container mt-5">
        <div class="card shadow-sm rounded p-4">
            <h1 class="text-primary mb-4">Agregar Empleado</h1>
            ...
            <form method="POST" action="{{ route('employees.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="identification_number" name="identification_number" required placeholder="Ingrese número de identificación">
                </div>

                <div class="mb-3">
                    <label for="salary" class="form-label">Salario</label>
                    <input type="number" step="0.01" class="form-control" id="salary" name="salary" required placeholder="Ingrese salario">
                </div>
